...
export const AGENTS: AgentMeta[] = [
  ...
  },
  {
    ...
    icon: "Crosshair",
    color: "text-rose-400",
    capabilities: ["Deep video-by-video analysis", "Title/thumbnail/transcript decoding", "Comment & audience-question mining", "Winning pattern extraction"],
    stage: "dossier",
  },
  {
  ...
  },
  {
    ...
    icon: "Image",
    color: "text-rose-400",
    capabilities: ["Detailed thumbnail briefs", "Visual layout & emotional triggers", "Mobile readability scoring", "Multiple AI generation prompts"],
    stage: "trifecta",
  },
  {
    type: "script_writer",
  ...
  },
  {
    type: "voice_dna",
    name: "Echo",
    role: "Voice DNA Analyst",
    icon: "Fingerprint",
    color: "text-violet-300",
    capabilities: ["Expanded voice profiling", "Writing style & vocabulary modeling", "Storytelling pattern capture", "Distinctiveness scoring"],
    stage: "interview",
  },
  {
    ...
    icon: "Clapperboard",
    color: "text-amber-400",
    capabilities: ["Scene-by-scene breakdowns", "B-roll & motion graphics plans", "Editor instructions", "Asset requirement specs"],
    stage: "blueprint",
  },
];
...
export const PIPELINE: PipelineStageInfo[] = [
  ...
  { key: "blueprint", label: "Production Blueprint", agent: "production_designer", requiresApproval: true, description: "Scene breakdowns, B-roll, motion graphics, editor instructions & asset requirements." },
